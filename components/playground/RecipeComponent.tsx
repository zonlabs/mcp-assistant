...
const RECIPE_DATA = [
  ...
  },
  {
    ...
    description: "Draft a clear and professional follow-up email using the available context. You should infer the appropriate subject and message content from relevant information such as recent discussions, meetings, tasks, or updates. The email should be concise, polite, and ready for review.",
